...
class ReturnPage extends StatefulWidget {
  ...
  ReturnPage(this.something,this.transid,this.pickadd,this.pickcon,this.picklat,this.picklong,this.mylat,this.mylong);

  State<StatefulWidget> createState() {


    return MyPage(this.something,this.transid,this.pickadd,this.pickcon,this.picklat,this.picklong,this.mylat,this.mylong);
  }
}
class MyPage extends State<ReturnPage> {
  String something,transid;
  String pickadd,pickcon;
  String picklat,picklong;

  String mylat,mylong;
  MyPage(this.something,this.transid,this.pickadd,this.pickcon,this.picklat,this.picklong,this.mylat,this.mylong);
  ...
  _launchURL() async {
    String url = "https://www.google.com/maps/dir/?api=1&origin=" +
        locations.location.latitude.toString() + "," + locations.location.longitude.toString()  + "&destination=" + picklat + "," + picklong + "&travelmode=driving&dir_action=navigate";
                ...
                background: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text("In-Transit to Origin", style: TextStyle(fontSize: 40, color: Colors.grey),),
