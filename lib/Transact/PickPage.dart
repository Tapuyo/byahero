...
class PickPage extends StatefulWidget {
  ...
  PickPage(this.something,this.transid,this.pickadd,this.pickcon,this.picklat,this.picklong,this.mylat,this.mylong);
...
class MyPage extends State<PickPage> {
  String something,transid;
  String pickadd,pickcon;
  String picklat,picklong;
                ...
                background: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text("Dispatch", style: TextStyle(fontSize: 40, color: Colors.grey),),
                        Text("Driver is on the way pickup point.", style: TextStyle(fontSize: 14, color: Colors.grey),)
                      ],
                    )
                )
